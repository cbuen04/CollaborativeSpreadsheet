...
namespace DevelopmentTests
{
    ...
    public class DependencyGraphTests
    {
        ...
        [TestMethod()]
        public void TestDependeesSizeGet()
        {
            DependencyGraph t1 = new DependencyGraph();
            t1.AddDependency("x", "y");
        ...
        [TestMethod()]
        public void TestDependeesSizeNonExistant()
        {
            DependencyGraph t1 = new DependencyGraph();
        ...
        [TestMethod()]
        public void TestDependeesSizeDeletedElement()
        {
            DependencyGraph t1 = new DependencyGraph();
            t1.AddDependency("x", "y");
            t1.RemoveDependency("x", "y");
            Assert.AreEqual(0, t1["y"]);
        }

        [TestMethod()]
        public void TestEmptyNoDependents()
        {
            DependencyGraph t1 = new DependencyGraph();
            Assert.IsFalse(t1.HasDependents("x"));
        }

        [TestMethod()]
        public void TestEmptyNoDependees()
        {
            DependencyGraph t1 = new DependencyGraph();
            Assert.IsFalse(t1.HasDependees("x"));
        }

        [TestMethod()]
        public void TestDoesHaveDependees()
        {
            DependencyGraph t1 = new DependencyGraph();
            t1.AddDependency("x", "y");
        ...
        [TestMethod()]
        public void TestDoesHaveDependents()
        {
            DependencyGraph t1 = new DependencyGraph();
            t1.AddDependency("x", "y");
            Assert.IsTrue(t1.HasDependents("x"));
        }

        [TestMethod()]
        public void TestNoDependentsAfterRemove()
        {
            DependencyGraph t1 = new DependencyGraph();
            t1.AddDependency("x", "y");
            t1.RemoveDependency("x", "y");
        ...
        [TestMethod()]
        public void TestNoDependeesAfterRemove()
        {
            DependencyGraph t1 = new DependencyGraph();
            t1.AddDependency("x", "y");
            t1.RemoveDependency("x", "y");
